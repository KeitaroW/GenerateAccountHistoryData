...
{
    class GenerateAccountHistoryData
    {
        public static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Usage: Uebung05_GenerateAccountHistoryData.exe <year> <month> <day> <number of days> <rows per day>");
                Console.WriteLine("or");
                Console.WriteLine("Usage: Uebung05_GenerateAccountHistoryData.exe \"<path>\" <year> <month> <day> <number of days> <rows per day>");
            }
        }
    }
}
